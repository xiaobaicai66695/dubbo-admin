...
const words: I18nType = {
  ...
  routingRuleDomain: {
    ...
    addRoute: 'Add Route',
    sourceMatch: 'Source match expression',
    destinations: 'Destinations',
    destinationMatch: 'Destination match expression',
    weight: 'Weight',
    addDestination: 'Add destination',
    structuredConditionHint:
      'v3.1 uses structured conditions: from.match selects requests and each to entry defines a destination match and weight.',
